...
<head>
    ...
    <title>Welcome to UK3 Login Form</title>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Animated Login Form with Starry Background</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <style>
        @keyframes fadeIn {
            from { opacity: 0; transform: translateY(-20px); }
...
<body class="bg-gradient-to-b from-gray-900 to-blue-900 h-screen flex items-center justify-center overflow-hidden">
    <div class="stars" id="stars"></div>
    <div class="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg p-8 rounded-lg shadow-lg w-96 animate-fadeIn">
        ...
        <form action="{{ route('login') }}" method="POST">
            ...
            <div class="mb-4 animate-fadeIn animate-delay-100">
                ...
                <input type="email" id="email" name="email" class="w-full px-3 py-2 bg-white bg-opacity-20 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 transition duration-200 text-white placeholder-gray-300" required autofocus>
            </div>
            <div class="mb-6 animate-fadeIn animate-delay-200">
                <label for="password" class="block text-gray-200 text-sm font-bold mb-2">Password</label>
                <input type="password" id="password" name="password" class="w-full px-3 py-2 bg-white bg-opacity-20 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 transition duration-200 text-white placeholder-gray-300" required>
            </div>
            <div class="flex items-center justify-between mb-6 animate-fadeIn animate-delay-300">
                <label class="flex items-center">
                    <input type="checkbox" name="remember" class="form-checkbox h-4 w-4 text-blue-400">
            ...
            <button type="submit" class="w-full bg-blue-500 text-white font-bold py-2 px-4 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-50 transition duration-200 animate-fadeIn animate-delay-300">
                Log In
            </button>
        </form>
    </div>
